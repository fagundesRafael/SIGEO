        ...
        {records.map((v, index) => (
          ...
          >
            ...
            {v.customTipo ? (
              ...
              <td className="border border-c_deep_black bg-c_deep_gray_black text-center p-1" title={v.tipo}>{v.tipo}</td>
            )}
            ...
            <td className="border border-c_deep_black bg-c_deep_gray_black text-center p-1" title={v.obs}>{v.obs?.length > 10 ? `${v.obs.substring(0, 10)}...` : v.obs}</td>
            <td className="border border-c_deep_black bg-c_deep_gray_black text-center p-1">
